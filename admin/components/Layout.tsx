...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <>
      <Head>
        <title>Antique Vault — Admin</title>
        <meta name="description" content="Antique collectibles tokenization vault" />
      </Head>
      <div className="min-h-screen bg-[#0f0f0f] text-white">
        <nav className="border-b border-[#2a2a2a] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/" className="text-amber-400 font-bold text-lg tracking-wide">
              ANTIQUE VAULT
            </Link>
